 ...
 */
final class Version20250717113644 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE checklist_logistique (id INT AUTO_INCREMENT NOT NULL, session_id INT NOT NULL, reservation_salle TINYINT(1) NOT NULL, machines_installees TINYINT(1) NOT NULL, formateur_confirme TINYINT(1) NOT NULL, supports_imprimes TINYINT(1) NOT NULL, convocations_envoyees TINYINT(1) NOT NULL, est_active TINYINT(1) NOT NULL, salle_reservee TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_329D2C5C613FECDF (session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE formateur (id INT AUTO_INCREMENT NOT NULL, deja_valide TINYINT(1) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, cv VARCHAR(255) DEFAULT NULL, est_valide TINYINT(1) DEFAULT NULL, niveau VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE formateur_validation (id INT AUTO_INCREMENT NOT NULL, formateur_id INT DEFAULT NULL, date_validation DATETIME NOT NULL, techniquement_valide TINYINT(1) NOT NULL, pedagogiquement_valide TINYINT(1) NOT NULL, commentaire LONGTEXT DEFAULT NULL, premiere_fois TINYINT(1) NOT NULL, INDEX IDX_43BB79FB155D8F51 (formateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE inscription (id INT AUTO_INCREMENT NOT NULL, session_id INT DEFAULT NULL, stagiaire_id INT DEFAULT NULL, date_inscription DATETIME NOT NULL, statut VARCHAR(50) NOT NULL, INDEX IDX_5E90F6D6613FECDF (session_id), INDEX IDX_5E90F6D6BBA93DD6 (stagiaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE note (id INT AUTO_INCREMENT NOT NULL, evaluation_id INT DEFAULT NULL, stagiaire_id INT DEFAULT NULL, valeur SMALLINT NOT NULL, date DATETIME NOT NULL, INDEX IDX_CFBDFA14456C5646 (evaluation_id), INDEX IDX_CFBDFA14BBA93DD6 (stagiaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, formation_id INT DEFAULT NULL, salle_id INT DEFAULT NULL, formateur_id INT DEFAULT NULL, etat VARCHAR(255) NOT NULL, date DATETIME NOT NULL, prix DOUBLE PRECISION NOT NULL, intitule VARCHAR(255) NOT NULL, min_participants INT NOT NULL, seuil_minimum INT NOT NULL, statut VARCHAR(50) NOT NULL, INDEX IDX_D044D5D45200282E (formation_id), INDEX IDX_D044D5D4DC304035 (salle_id), INDEX IDX_D044D5D4155D8F51 (formateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
